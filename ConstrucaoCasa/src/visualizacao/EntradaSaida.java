...
public class EntradaSaida {
	...
	public static int solicitaQtdeAberturas(String abertura) {
		...
		int numeroDeAberturas = 0;

		do {
			numeroDeAberturas = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade de " + abertura));

			if (numeroDeAberturas <= 0) {
				JOptionPane.showMessageDialog(null, "É necessário informar um valor maior que 0!");
			}

		} while (numeroDeAberturas <= 0);

		return numeroDeAberturas;
	}
	...
	public static void casaConstruidaMsg() {
		JOptionPane.showMessageDialog(null, "É necessário construir a casa primeiro!");
	}
